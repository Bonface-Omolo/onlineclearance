...
<body>
	...
	<nav>
		<ul>
			<li><a href="hod-home.php">HOME</a></li>
			<li><a href="about.php">ABOUT</a></li>
			
			<li><a href="hodlogin.php">LOGOUT</a></li>
		</ul>
	</nav>
</header>
<div class="bgsize" >
			...
			?>
				...
				<tr>
					<form action="" method="post">
						...
						<td>
							<a href='hod-edit.php?unitid=<?php echo $row['id']; ?>' type="submit" name="edit" value="Edit" style="text-decoration:none;padding:3px;border-radius:4px;border:none;background-color:steelblue;color:white">Clearance</a>
